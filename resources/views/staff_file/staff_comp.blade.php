...
<nav class="navbar navbar-light bg-info">
  <span class="navbar-brand text-white mb-0 h1">Welcome to the admin clearance portal</span>
  <form class="form-inline my-2 my-lg-0">
      ...
      <td>@if ($element['req_status']== 1 && $element['status']==1)
        ...
        @else
            @if ($element['req_status']==1 && $element['status']==0)
              ...
              <a href="{{url('/status_update_comp',$element->id)}}" class="btn btn-success">Active</a>
